module("combobox test", { 
	setup: function(){
        S.open("//canui/form/combobox/combobox.html");
	}
})


test("Test change is only called once.", function() {
	S("#expirationBehavior .can_ui_form_combobox_select").click();
	S(".can_ui_form_combobox_dropdown .dropdown_2").visible();
	S(".can_ui_form_combobox_dropdown .dropdown_2").click();
...
test("Test clicking combobox view in text mode and verify the dropdown opens.", function() {
	S("#expirationBehavior .can_ui_form_combobox_select").exists(function(){
	...
	S("#expirationBehavior .can_ui_form_combobox_select").click( function(){
		var display = S(".can_ui_form_combobox_dropdown").css("display");
...
test("Test clicking item 2 and check it was selected.", function() {
	S(".can_ui_form_combobox .can_ui_form_combobox_select").click();
	
	S(".can_ui_form_combobox_dropdown .dropdown_2").visible();
	
	S(".can_ui_form_combobox_dropdown .dropdown_2").click(function(){
...
test("Test that change event is triggered when the combobox value is changed.", function() {
	...
	S(".can_ui_form_combobox_dropdown").visible();
	
		
	S(".can_ui_form_combobox_dropdown .dropdown_3").exists();
	S(".can_ui_form_combobox_dropdown .dropdown_3").click();
